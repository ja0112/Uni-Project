...
$sql = "SELECT *
        ...
        WHERE admin_privilege = 'Event Manager'";
...
<p>This is a request that has been sent to you from <?php echo "$firstnam $surnam&nbsp;"; ?>
  as they would like you to volunteer at thier upcoming event <strong><?php echo $event_title;?></strong>.</p>

  <p>Attached is a link to the <?php echo "$firstnam's &nbsp;";?>event to help you decide.</p>

  <p><?php echo "$firstnam&nbsp";?>says:</p>
  <p><em>"<?php echo $reason;?>"</em></p>
<?php  echo "<a class=\"button\" href=\"event-details.php?event_id=$event_id\">View Event</a>";?>

<?php  echo "<a class=\"button\" href=\"request-accepted-volunteer.php?email=$email&user_id=$user_id&event_id=$event_id\">Accept</a>";?>
