...
<input type="button" value="Next" onclick="showDayPrevious();" class="planner-next-btn" >
 <h2 class="day">Monday 21 April</h2>
...
$eventSql = "SELECT *
             FROM IP_planner AS a INNER JOIN IP_create_event
                        ...
                        WHERE a.user_id = '$user_id' AND event_date BETWEEN '2018-04-21' AND '2018-03-21'";
