...
echo timeout();
 ...
 <input type="button" value="Next" onclick="showDayNext();" class="planner-next-button" >
 <input type="button" value="Previous" onclick="showPreviousDay();" class="planner-previous-button" >
 <h2 class="day">Tuesday 22 April</h2>
...
$eventSql = "SELECT *
             FROM IP_planner AS a INNER JOIN IP_create_event
                        ...
                        WHERE a.user_id = '$user_id' AND event_date BETWEEN '2018-03-15' AND '2018-03-16'";
