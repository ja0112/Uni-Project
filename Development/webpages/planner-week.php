...
<input type="button" value="Next" onclick="showNextWeek();" class="planner-week-next-btn" >
<input type="button" value="Previous" onclick="showPreviousWeekly();" class="planner-week-previous-btn" >
 <h2 class="day">WC 23 April</h2>
<?php
$eventSql = "SELECT *
             FROM IP_planner AS a INNER JOIN IP_create_event
                        ...
                        WHERE a.user_id = '$user_id' AND event_date BETWEEN '2018-04-23' AND '2018-04-30'";
