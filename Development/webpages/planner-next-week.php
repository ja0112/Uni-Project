...
<input type="button" value="Next" onclick="" class="planner-week-next-btn" >
<input type="button" value="Previous" onclick="plannerPreviousWeek();" class="planner-week-previous-btn" >
 <h2 class="day">WC 7 May</h2>
<?php
$eventSql = "SELECT *
             FROM IP_planner AS a INNER JOIN IP_create_event
                        ...
                        WHERE a.user_id = '$user_id' AND event_date BETWEEN '2018-05-07' AND '2018-05-07'";
